...
SESSION_COOKIE_NAME = "permyt-luckwing"
...
CELERY_TASK_DEFAULT_QUEUE = "permyt-luckwing-dev-celery-"
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            ...
            "prefix": "permyt-luckwing-dev-channels-",
        },
    }
}
...
CACHES = {
    "default": {
        ...
        "KEY_PREFIX": "permyt-luckwing-dev-cache-",
    }
}
...
BASE_URL = os.environ.get("BASE_URL", "http://localhost:9020")
...
# The consumer iGaming brand opening player accounts. Shown across the UI
# ("Open your {ORGANIZATION_NAME} account", navbar, footer).
ORGANIZATION_NAME = os.environ.get("ORGANIZATION_NAME", "Luckwing")
