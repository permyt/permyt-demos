...
SESSION_COOKIE_NAME = "permyt-stripe"
...
CELERY_TASK_DEFAULT_QUEUE = "permyt-stripe-dev-celery-"
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            ...
            "prefix": "permyt-stripe-dev-channels-",
        },
    }
}
...
CACHES = {
    "default": {
        ...
        "KEY_PREFIX": "permyt-stripe-dev-cache-",
    }
}
...
BASE_URL = os.environ.get("BASE_URL", "http://localhost:9016")
...
# ---------------------------------------------------------------------------
# Stripe (test mode) — the marketplace pushes pulled facts into a Connect
# connected account. Use a test-mode secret key (sk_test_...).
# ---------------------------------------------------------------------------
STRIPE_SECRET_KEY = os.environ.get("STRIPE_SECRET_KEY", "")
STRIPE_ACCOUNT_COUNTRY = os.environ.get("STRIPE_ACCOUNT_COUNTRY", "GB")
# In test mode, substitute Stripe's magic verification values so the connected
# account clears verification without real documents.
STRIPE_USE_TEST_VALUES = os.environ.get("STRIPE_USE_TEST_VALUES", "true").lower() == "true"
# IP recorded for the custom account's Terms-of-Service acceptance.
STRIPE_TOS_IP = os.environ.get("STRIPE_TOS_IP", "127.0.0.1")

# The platform/marketplace onboarding companies as connected accounts. Shown in
# the UI ("Add a company to {ORGANIZATION_NAME}").
ORGANIZATION_NAME = os.environ.get("ORGANIZATION_NAME", "Northwind Marketplace")
