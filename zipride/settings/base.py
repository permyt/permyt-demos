...
SESSION_COOKIE_NAME = "permyt-zipride"
...
CELERY_TASK_DEFAULT_QUEUE = "permyt-zipride-dev-celery-"
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            ...
            "prefix": "permyt-zipride-dev-channels-",
        },
    }
}
...
CACHES = {
    "default": {
        ...
        "KEY_PREFIX": "permyt-zipride-dev-cache-",
    }
}
...
BASE_URL = os.environ.get("BASE_URL", "http://localhost:9021")
...
# The platform onboarding drivers. Shown in the UI ("Start driving with
# {ORGANIZATION_NAME}").
ORGANIZATION_NAME = os.environ.get("ORGANIZATION_NAME", "Zipride")
