...
SESSION_COOKIE_NAME = "permyt-hotel"
...
CELERY_TASK_DEFAULT_QUEUE = "permyt-hotel-dev-celery-"
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            ...
            "prefix": "permyt-hotel-dev-channels-",
        },
    }
}
...
CACHES = {
    "default": {
        ...
        "KEY_PREFIX": "permyt-hotel-dev-cache-",
    }
}
...
BASE_URL = os.environ.get("BASE_URL", "http://localhost:9014")
...
HOTEL_NIGHTLY_RATE = Decimal(os.environ.get("HOTEL_NIGHTLY_RATE", "120.00"))
HOTEL_CURRENCY = os.environ.get("HOTEL_CURRENCY", "EUR")
HOTEL_IBAN = os.environ.get("HOTEL_IBAN", "PT50000000000000000000000")
HOTEL_NAME = os.environ.get("HOTEL_NAME", "The Aurelia")
