...
class NoteWriteSerializer(ScopeSerializer):  # pylint: disable=abstract-method
    """Input for write scopes — a single content field."""

    content = serializers.CharField(
        required=True,
        allow_blank=True,
        help_text="Text content to write to the field.",
    )
