"""Root conftest -- shared fixtures for the Company-Agent provider test suite."""
...
from app.core.users.factories import CompanyKBFactory


@pytest.fixture
def user(db):
    """A company user with a populated knowledge base."""
    kb = CompanyKBFactory()
    return kb.user
...
def make_token(db):
    ...
    def _make(user, scope_grant=None, used=False, expires_in_minutes=5):
        return RequestToken.objects.create(
            ...
            scope=scope_grant or {"business_plan.read": {}},
