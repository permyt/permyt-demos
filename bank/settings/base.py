...
SESSION_COOKIE_NAME = "permyt-bank"
...
CELERY_TASK_DEFAULT_QUEUE = "permyt-bank-dev-celery-"
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            ...
            "prefix": "permyt-bank-dev-channels-",
        },
    }
}
...
CACHES = {
    "default": {
        ...
        "KEY_PREFIX": "permyt-bank-dev-cache-",
    }
}
...
BASE_URL = os.environ.get("BASE_URL", "http://localhost:9013")
NONCE_TTL_SECONDS = int(os.environ.get("NONCE_TTL_SECONDS", "60"))

# Requester-side callback. The bank acts as a PERMYT *requester* during
# onboarding (it asks the government provider for the new account holder's
# verified identity). The broker posts request-status updates back here.
