/* Vaulton KYC dashboard: live stage track + source-direct answer reveal,
...
(function () {
  ...
  function applyRow(fields) {
    ...
    if (stage === "done") showResult();
    if (failed) {
      setLive("We couldn't complete verification — " + (d.reason || d.error || d.note || "please try again."), true);
