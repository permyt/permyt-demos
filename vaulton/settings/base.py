...
SESSION_COOKIE_NAME = "permyt-vaulton"
...
CELERY_TASK_DEFAULT_QUEUE = "permyt-vaulton-dev-celery-"
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            ...
            "prefix": "permyt-vaulton-dev-channels-",
        },
    }
}
...
CACHES = {
    "default": {
        ...
        "KEY_PREFIX": "permyt-vaulton-dev-cache-",
    }
}
...
# The crypto-asset exchange verifying new traders. Shown in the UI.
ORGANIZATION_NAME = os.environ.get("ORGANIZATION_NAME", "Vaulton")
