...
SESSION_COOKIE_NAME = "permyt-sentinel"
...
CELERY_TASK_DEFAULT_QUEUE = "permyt-sentinel-dev-celery-"
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            ...
            "prefix": "permyt-sentinel-dev-channels-",
        },
    }
}
...
CACHES = {
    "default": {
        ...
        "KEY_PREFIX": "permyt-sentinel-dev-cache-",
    }
}
...
BASE_URL = os.environ.get("BASE_URL", "http://localhost:9018")
